...
# 2. Récupération automatique de la clé API via Streamlit Secrets
api_key = st.secrets.get("OPENAI_API_KEY", "")

# Si pour une raison quelconque la clé n'est pas dans les Secrets, on laisse une option manuelle
if not api_key:
...
3. Structure ta réponse avec des émojis pour les codes couleurs (🟢 Conforme, 🟠 Restriction/Vigilance, 🔴 Interdit/Novel Food)."""
            ...
            try:
                ...
                st.error("Erreur avec l'API OpenAI. Vérifiez votre solde ou votre clé.")
{base_de_donnees}
